import { TreeDiagramNode } from './tree-diagram-node.class';
import { TreeDiagramNodeMaker } from './tree-diagram-node-maker.class';
...
export class TreeDiagramNodesList {
  ...
  constructor (_nodes: any[], private config) {
    _nodes.forEach((_node) => {
      this._nodesList.set(
        _node.guid,
        new TreeDiagramNode(_node, config, this.getThisNodeList.bind(this)));
    });
    this._makeRoots();
